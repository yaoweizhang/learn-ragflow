...
```
[server_whitepaper.pdf#1] score=0.976 | ... 内存、10 个 PCIe 4.0 扩展槽位 ...
[server_whitepaper.pdf#2] score=0.905 | 内存 32 × DDR4 3200 ECC RDIMM ...
[server_whitepaper.pdf#4] score=0.869 | 内存支持镜像、备用与纠错码（ECC）三种数据保护模式 ...
```
