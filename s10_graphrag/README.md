...
graph = {
    "紫光恒越技术有限公司": {("版权所有", "紫光恒越 R3630 G5 双路机架式服务器 产品白皮书 v1.0"),
                             ("拥有版权", "紫光恒越 R3630 G5 双路机架式服务器 产品白皮书 v1.0")},
    "3.1 技术规格": {("属于", "3 产品规格")},
    ...
}
query_graph(graph, "紫光恒越技术有限公司")
# → [("版权所有", "紫光恒越 R3630 G5 双路机架式服务器 产品白皮书 v1.0"),
#    ("拥有版权", "紫光恒越 R3630 G5 双路机架式服务器 产品白皮书 v1.0")]
```
...
1. **实体歧义 / 一物多名**——"紫光恒越"和"紫光恒越技术有限公司"在白皮书里指同一
   家公司，但 LLM 会当成两个节点建两条边。MVP 的 `dict` 不会合并。生产里要做 **entity
