...
- [RAG 技术综述](./docs/00-intro/01_what_is_rag.md) — RAG 是什么、与长上下文的权衡、技术演进
- [`docs/` 目录说明](./docs/00-intro/README.md) — `docs/` 的使用方法 + 与 `sXX_topic/` 的边界
