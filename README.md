...
- [x] *（延伸阅读）* [RAG 技术综述](./s00_concepts/)（参数化 vs. 非参数化知识；初级 / 高级 / 模块化 RAG）
...
- [RAG 技术综述](./s00_concepts/) — RAG 是什么、与长上下文的权衡、技术演进
- [`docs/` 目录说明](./s00_concepts/README.md) — `s00_concepts/` 的使用方法 + 与 `sXX_topic/` 的边界
