...
>
> **章节结构**：2 个 unit。unit 01 用 BAAI/bge-small-zh-v1.5 在本地 CPU 跑 embedding；unit 02 加 provider 路由层，让 `EMBED_PROVIDER` 在 local / openai / ollama 之间切。
>
